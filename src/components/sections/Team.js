...
const Team = (props) => {
  ...
  return (
    <div className="Team">
      <Grid>
        <TeamCard name="Pehuén Rodriguez" position="Sr. full-stack developer" knowledge={ [ 'node-js', 'elixir','reactjs', 'mongodb', 'postgres' ] } cv={require('../../assets/cvs/CV_PehuenRodriguez.pdf')} github="/pehuenrodriguez" linkedin="/pehuenrodriguez" img={require('../../assets/img/pehue.jpg')} />
        ...
        <TeamCard name="Ignacio Guerra" position="Sr. interactive developer" knowledge={ [ 'vuejs', 'reactjs', 'javascript', 'html5' , 'css3-alt'] } cv={require('../../assets/cvs/CV_IgnacioGuerra.pdf')} github="/ignacioguerra" linkedin="/ignacio-guerra" img={require('../../assets/img/nacho.jpg')} />
        <TeamCard name="Tobías Irigoyen" position="Sr. frontend developer" knowledge={ [ 'html5', 'css3-alt', 'vuejs' ] } cv='' github="/tobias-irigoyen" linkedin="/tobiasirigoyen" img={require('../../assets/img/tobi.jpg')} />
